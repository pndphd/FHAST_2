...
abm_summary_stats = readRDS(file = here(output_temp_folder,  "abm_summary_table.rds"))

predator_rating_area = readRDS(file = here(output_temp_folder,  "predator_rating_area_stats_table.rds"))

mort_risk_area_stat = readRDS(file = here(output_temp_folder,  "mort_risk_area_stats_table.rds"))

fish_parm = readRDS(file = here(output_temp_folder,  "fish_parm.rds")) 

pred_map = here(output_temp_folder,  "predator_map.png")

fish_pred_plot = here(output_temp_folder,  "predation_map.png")

abm_rearing_plot = here(output_temp_folder,  "abm_rearing_plot.png")

abm_growth_plot = here(output_temp_folder,  "abm_growth_plot.png")

abm_count_v_growth_plot = here(output_temp_folder,  "abm_count_v_growth_plot.png")

abm_count_v_length_plot = here(output_temp_folder,  "abm_count_v_length_plot.png")

abm_mortality_plot = here(output_temp_folder,  "abm_mortality_plot.png")
```
