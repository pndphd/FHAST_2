...
class AddColumn:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Add Column')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('AddColumn', message)
    ...
    def run(self):
        ...
        if result:
            ...
            add_file = self.dlg.add_column_select.currentLayer()
