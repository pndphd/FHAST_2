...
if 'GISBASE' in os.environ and len(os.getenv('GISBASE')) > 0:
    ...
    GISBASE = os.path.normpath("/c/OSGeo4W64/apps/grass/grass78")
    os.environ['GISBASE'] = GISBASE
CMD_NAME = "grass78"
GRASS_VERSION = "7.8.5"
LD_LIBRARY_PATH_VAR = 'PATH'
CONFIG_PROJSHARE = os.environ.get('GRASS_PROJSHARE', "/c/OSGeo4W64/share/proj")
